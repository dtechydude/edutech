...
from attendance.models import Dept, Class, Student, Attendance, Course, Teacher, Assign, AttendanceTotal, time_slots, \
    DAYS_OF_WEEK, AssignTime, AttendanceClass, StudentCourse, Marks, MarksClass



# New Attendance Module Starts here...

@login_required
def index(request):
    if request.user.staffprofile.staff_role == 'form_teacher':
...
def change_att(request, att_id):
    ...
    a.save()
    return HttpResponseRedirect(reverse('attendance:t_attendance_detail', args=(a.student.USN, a.course_id)))
...
def marks_list(request, stud_id):
    ...
    return render(request, 'attendance/marks_list.html', {'sc_list': sc_list})
...
def t_marks_list(request, assign_id):
    ...
    return render(request, 'attendance/t_marks_list.html', {'m_list': m_list})
...
def t_marks_entry(request, marks_c_id):
    ...
    return render(request, 'attendance/t_marks_entry.html', context)
...
def marks_confirm(request, marks_c_id):
    ...
    return HttpResponseRedirect(reverse('attendance:t_marks_list', args=(ass.id,)))
...
def edit_marks(request, marks_c_id):
    ...
    return render(request, 'attendance/edit_marks.html', context)
...
def student_marks(request, assign_id):
    ...
    return render(request, 'attendance/t_student_marks.html', {'sc_list': sc_list})
