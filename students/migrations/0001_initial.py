    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_status', models.CharField(choices=[('active', 'active'), ('graduated', 'graduated'), ('dropped', 'dropped'), ('expelled', 'expelled'), ('suspended', 'suspended')], default='active', max_length=15)),
